...
from src.open_source.clip import CLIP, convert_weights
from src.open_source.clip.simple_tokenizer import SimpleTokenizer, default_bpe
...
src.open_source.clip.model.LayerNorm = LayerNorm
delattr(src.open_source.clip.model.CLIP, "forward")
