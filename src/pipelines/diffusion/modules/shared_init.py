...
def initialize():
    ...
    from src.pipelines.diffusion.modules import options, shared_options
    ...
    from src.pipelines.diffusion.modules import shared_state
    shared.state = shared_state.State()

    from src.pipelines.diffusion.modules import styles
    shared.prompt_styles = styles.StyleDatabase(shared.styles_filename)

    from src.pipelines.diffusion.modules import interrogate
    shared.interrogator = interrogate.InterrogateModels("interrogate")

    from src.pipelines.diffusion.modules import shared_total_tqdm
    shared.total_tqdm = shared_total_tqdm.TotalTQDM()

    from src.pipelines.diffusion.modules import memmon, devices
